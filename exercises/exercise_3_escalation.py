    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                "for the reviewer. Reference the relevant file or diff section. "
...
def node_synthesize(state: ReviewState) -> dict:
    ...
    qa = "\n".join(f"Q: {q}\nA: {answer}" for q, answer in answers.items())
        ...
        refined = llm.invoke([
            {
                ...
                "content": (
                    ...
                    "review using the reviewer answers. Keep actionable findings, "
                    "remove concerns answered by the human, and update confidence."
                ),
            },
            {
                "role": "user",
