    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                ">=0.73 only for low-risk mechanical changes; 0.58-0.72 for "
                "medium-risk small features, schema additions, validation, testing, "
                "or documentation questions; <0.58 only for high-risk security, auth, "
                "credential, injection, data-loss, or destructive migration concerns."
            )},
